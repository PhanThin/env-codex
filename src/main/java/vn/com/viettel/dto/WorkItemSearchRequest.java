...
@Getter
@Setter
@Schema(description = "Đối tượng chứa điều kiện tìm kiếm công việc")
public class WorkItemSearchRequest {
    @Schema(description = "Từ khóa tìm kiếm có thể là ID, mã, tên công việc")
    ...
    @Schema(description = "ID của hạng mục công việc. Null nếu tìm kiếm toàn bộ")
    private Long categoryWorkItemId;
