...
public class RecommendationMapper {
    ...
    public List<RecommendationDto> mapToDtoList(List<Recommendation> recommendations) {
        ...
        Map<Long, SysUser> sysUserMap = !userIds.isEmpty() ? sysUserRepo.findAllByIdInAndIsDeletedFalse(userIds).stream().collect(Collectors.toMap(SysUser::getId, Function.identity())) : null;

        return recommendations.stream()
                .map(recommendation -> toDto(recommendation, projectMap, recommendationTypeMap, phaseMap, workItemMap, recommendationWorkItemMap, projectItemMap, sysUserMap))
                .toList();
    }
    ...
    public List<RecommendationWorkItem> mapToDtoList(List<WorkItemDto> workItemDtos, Long recommendationId, Long userId) {
