...
public class CatScheduleAdjReasonController {
    ...
    @PostMapping("/search")
    public ResponseEntity<Page<CatScheduleAdjReasonDto>> search(@Parameter(description = "Tiêu chí tìm kiếm") @RequestBody CatScheduleAdjReasonSearchRequestDto request) {
